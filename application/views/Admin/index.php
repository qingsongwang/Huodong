...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>static/admin/css/compiled/index.css" type="text/css" media="screen" />    
...
<body>
            ...
            <ul class="nav pull-right">                
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?=site_url('admin/personal_info')?>">个人信息</a></li>
                        <li><a href="#">账户设置</a></li>
    ...
    <script src="<?=base_url()?>static/admin/js/jquery-ui-1.10.2.custom.min.js"></script>
    <!-- knob -->
    <script src="<?=base_url()?>static/admin/js/jquery.knob.js"></script>
    <!-- flot charts -->
    <script src="<?=base_url()?>static/admin/js/jquery.flot.js"></script>
    <script src="<?=base_url()?>static/admin/js/jquery.flot.stack.js"></script>
    <script src="<?=base_url()?>static/admin/js/jquery.flot.resize.js"></script>
