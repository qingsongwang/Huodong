...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            <a class="brand" href="index.html"><h2 style="color:white">爱活动</h2></a>
            ...
            <div class="settings-wrapper" id="pad-wrapper">
                ...
                <div class="span3 avatar-box">
                    <div class="personal-image">
                        <img src="<?=base_url()?>static/admin/img/personal-info.png" class="avatar img-circle" />
                        <p>更换你的头像</p>
                ...
                <div class="span7 personal-info">
                    ...
                    <form />
                        <div class="field-box">
                            <label>姓名:</label>
                            <input class="span5 inline-input" type="text" value="汪青松" />
                        </div>
                        <div class="field-box">
                            <label>学号:</label>
                            <input class="span5 inline-input" type="text" value="1004031010" />
                        </div>
                        <div class="field-box">
                            <label>性别:</label>
                            <div class="ui-select">
                        ...
                        <div class="field-box">
                            <label>Email:</label>
                            <input class="span5 inline-input" type="text" value="cnsongzi@foxmail.com" />
                        </div>
                        <div class="field-box">
                            <label>系部:</label>
                            <div class="ui-select">
                        ...
                        <div class="field-box">
                            <label>年龄:</label>
                            <input class="span5 inline-input" type="text" value="23" />
                        </div>
						<div class="field-box">
                            <label>身份证:</label>
                            <input class="span5 inline-input" type="text" value="342425199312016588" />
                        </div>
						 <div class="field-box">
                            <label>政治面貌:</label>
                            <div class="ui-select">
						...
						<div class="field-box">
                            <label>地址:</label>
                            <input class="span5 inline-input" type="text" value="安徽省合肥市锦绣大道" />
                        </div>
                       	<div class="field-box">
                            <label>特长:</label>
                            <input class="span5 inline-input" type="text" value="摄影，篮球" />
                        </div>
							<div class="field-box">
                            <label>签名:</label>
                            <input class="span5 inline-input" type="text" value="风一样的男子" />
                        </div>
